...
function bio.load()
	...
	bio.middlefont = love.graphics.newFont(25)
...
function bio.draw()
	...
	love.graphics.printf("His travels took him to the Galapagos Islands off the coast of South America in 1835. He", 755, 78, 185)
	love.graphics.printf("thought he was sending home many different types of bird species only to discover that they were all finches. The amazing amount of variability in these finches was an important observation which led Darwin to develop the concept of natural selection and the theory of evolution. Darwin died in 1882. He is buried in Westminster Abbey, not far from another famous British scientist, Sir Isaac Newton.", 555, 278, 410)
	love.graphics.setColor(1, 1, 1)
end
